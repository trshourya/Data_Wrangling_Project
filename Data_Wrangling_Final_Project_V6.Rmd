...
all_reviews_chromeast= import(file = 'chromecast_reviews.Rda')
...
titlePanel("Amazon Review Application"),
...
#,mainPanel(plotOutput("hist"),plotOutput("hist2"))
))
...
#     if(input$date_level == 'date_level'){
#       hist(rnorm(1000), nclass=5)
#     }
#     else{
#       hist(rnorm(1000), nclass=25)
#     }
# }
# })
...
# titlePanel("Amazon Review Application"),
# sidebarLayout(sidebarPanel(selectInput("product", label = "Select Product", choices = list("Amazon Fire Stick" = "firestick", "Roku" = "roku", "Google Chromecast" = "chromecast"), selected = "firestick"),
# selectInput("lexicons", label = "Select Lexicons", choices = list("Afinn" = "afinn", "Bing" = "bing", "NRC" = "nrc"), selected = "afinn"),radioButtons(inputId = 'date_level',label = 'Date',choices = list("Date level" = "date_level","Month level" = "month_level"),selected = "date_level" )
# ) ,mainPanel(plotOutput("hist"),plotOutput("hist2"))
# #,mainPanel(plotOutput("hist"),plotOutput("hist2"))
# ))
# 
...
# # server <- function(input, output) {
# # 
# # #all_reviews_cleaned is the common variable
# # # if(input$product == 'firestick'){
# # #   load("amazon_firestick_reviews.Rda")
# # #   all_reviews_cleaned = all_reviews_firestick
# # # }
...
# # # hist(rnorm(1000), nclass=input$product)
# # # })
# # }
# 
# # 
...
# # server <- function(input, output) {
# # output$hist <- renderPlot({
# # hist(rnorm(1000), nclass=input$num)
# # })
# # }
